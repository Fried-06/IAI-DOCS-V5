...
<head>
    ...
    <title>Analyse Numerique - Ressources IAI</title>
    <meta name="description" content="Ressources de la matiere Analyse Numerique pour Licence 3 GLSI - Semestre 5">
    <base href="<?= $base_url ?>/">
...
<body class="page-fade-in">
    ...
    <main class="container" style="padding: 4rem 0;">
        <div class="subject-header">
            <h1 style="color: var(--primary); margin-bottom: 0.5rem;">Analyse Numerique</h1>
