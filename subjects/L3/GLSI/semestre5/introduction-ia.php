...
try {
    ...
    $stmt->execute([
        ':level'    => 'L3 GLSI',
        ':semester' => 'Semestre 5',
        ':subject'  => 'Intelligence_Artificielle'
    ]);
...
<head>
    ...
    <title>Intro a l&#x27;Intelligence Artificielle - Ressources IAI</title>
    <meta name="description" content="Ressources de la matiere Intro a l&#x27;Intelligence Artificielle pour Licence 3 GLSI - Semestre 5">
    <base href="<?= $base_url ?>/">
...
<body class="page-fade-in">
    ...
    <main class="container" style="padding: 4rem 0;">
        <div class="subject-header">
            <h1 style="color: var(--primary); margin-bottom: 0.5rem;">Intro a l&#x27;Intelligence Artificielle</h1>
