...
try {
    ...
    $stmt->execute([
        ':level'    => 'L3 GLSI',
        ':semester' => 'Semestre 5',
        ':subject'  => 'Systeme_Information_Geographique'
    ]);
...
<head>
    ...
    <title>Systeme d&#x27;Information Geographique - Ressources IAI</title>
    <meta name="description" content="Ressources de la matiere Systeme d&#x27;Information Geographique pour Licence 3 GLSI - Semestre 5">
    <base href="<?= $base_url ?>/">
...
<body class="page-fade-in">
    ...
    <main class="container" style="padding: 4rem 0;">
        <div class="subject-header">
            <h1 style="color: var(--primary); margin-bottom: 0.5rem;">Systeme d&#x27;Information Geographique</h1>
