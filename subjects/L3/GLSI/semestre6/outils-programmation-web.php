...
try {
    ...
    $stmt->execute([
        ':level'    => 'L3 GLSI',
        ':semester' => 'Semestre 6',
        ':subject'  => 'Seminaires_Professionnels'
    ]);
...
<head>
    ...
    <title>Seminaires Professionnels - Ressources IAI</title>
    <meta name="description" content="Ressources de la matiere Seminaires Professionnels pour Licence 3 GLSI - Semestre 6">
    <base href="<?= $base_url ?>/">
...
<body class="page-fade-in">
    ...
    <main class="container" style="padding: 4rem 0;">
        <div class="subject-header">
            <h1 style="color: var(--primary); margin-bottom: 0.5rem;">Seminaires Professionnels</h1>
            <p style="color: var(--text-muted); margin-bottom: 1rem;">Licence 3 GLSI - Semestre 6</p>
