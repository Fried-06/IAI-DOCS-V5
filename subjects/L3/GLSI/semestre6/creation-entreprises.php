...
<head>
    ...
    <title>Creation d&#x27;Entreprises - Ressources IAI</title>
    <meta name="description" content="Ressources de la matiere Creation d&#x27;Entreprises pour Licence 3 GLSI - Semestre 6">
    <base href="<?= $base_url ?>/">
...
<body class="page-fade-in">
    ...
    <main class="container" style="padding: 4rem 0;">
        <div class="subject-header">
            <h1 style="color: var(--primary); margin-bottom: 0.5rem;">Creation d&#x27;Entreprises</h1>
