...
try {
    ...
    $stmt->execute([
        ':level'    => 'L3 ASR',
        ':semester' => 'Semestre 6',
        ':subject'  => 'Techniques Multimedia et Infographie'
    ]);
...
<head>
    ...
    <title>Techniques Multimedia et Infographie - Ressources IAI</title>
    <meta name="description" content="Ressources de la matiere Techniques Multimedia et Infographie pour Licence 3 ASR - Semestre 6">
    <base href="<?= $base_url ?>/">
...
<body class="page-fade-in">
    ...
    <main class="container" style="padding: 4rem 0;">
        <div class="subject-header">
            <h1 style="color: var(--primary); margin-bottom: 0.5rem;">Techniques Multimedia et Infographie</h1>
            <p style="color: var(--text-muted); margin-bottom: 1rem;">Licence 3 ASR - Semestre 6</p>
