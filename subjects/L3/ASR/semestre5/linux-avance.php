...
try {
    ...
    $stmt->execute([
        ':level'    => 'L3 ASR',
        ':semester' => 'Semestre 5',
        ':subject'  => 'Administration_Systeme_Avancee'
    ]);
...
<head>
    ...
    <title>Administration Systeme Avancee (Linux) - Ressources IAI</title>
    <meta name="description" content="Ressources de la matiere Administration Systeme Avancee (Linux) pour Licence 3 ASR - Semestre 5">
    <base href="<?= $base_url ?>/">
...
<body class="page-fade-in">
    ...
    <main class="container" style="padding: 4rem 0;">
        <div class="subject-header">
            <h1 style="color: var(--primary); margin-bottom: 0.5rem;">Administration Systeme Avancee (Linux)</h1>
