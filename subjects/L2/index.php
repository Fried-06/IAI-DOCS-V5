...
<head>
    ...
    <title>Licence 2 - Ressources IAI</title>
...
<body>
    ...
    <main class="container" style="padding: 4rem 0;">
        <h1 style='color: var(--primary); margin-bottom: 2rem; text-align: center;'>Licence 2</h1><div class='grid grid-cols-2'>        <a href="semestre4.php" class="level-card">
            ...
            <div>
                <div class="level-title">Semestre 4</div>
                <div class="level-desc">Voir les mati̬res de ce semestre</div>
            </div>
        </a>        <a href="semestre3.php" class="level-card">
            <div class="level-icon">
                <svg width="32" height="32" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path></svg>
            </div>
            <div>
                <div class="level-title">Semestre 3</div>
                <div class="level-desc">Voir les mati̬res de ce semestre</div>
            </div>
        </a></div>
    </main>
