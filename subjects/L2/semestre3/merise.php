...
<head>
    ...
    <title>Merise - Ressources IAI</title>
    <meta name="description" content="Ressources de la matiere Merise pour Licence 2 - Semestre 3">
    <base href="<?= $base_url ?>/">
...
<body class="page-fade-in">
    ...
    <main class="container" style="padding: 4rem 0;">
        <div class="subject-header">
            <h1 style="color: var(--primary); margin-bottom: 0.5rem;">Merise</h1>
