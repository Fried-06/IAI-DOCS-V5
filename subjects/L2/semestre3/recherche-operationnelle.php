...
try {
    ...
    $stmt->execute([
        ':level'    => 'L2',
        ':semester' => 'Semestre 3',
        ':subject'  => 'Recherche_Operationnelle'
    ]);
...
<head>
    ...
    <title>Recherche Operationnelle - Ressources IAI</title>
    <meta name="description" content="Ressources de la matiere Recherche Operationnelle pour Licence 2 - Semestre 3">
    <base href="<?= $base_url ?>/">
...
<body class="page-fade-in">
    ...
    <main class="container" style="padding: 4rem 0;">
        <div class="subject-header">
            <h1 style="color: var(--primary); margin-bottom: 0.5rem;">Recherche Operationnelle</h1>
            <p style="color: var(--text-muted); margin-bottom: 1rem;">Licence 2 - Semestre 3</p>
