...
try {
    ...
    $stmt->execute([
        ':level'    => 'L2',
        ':semester' => 'Semestre 4',
        ':subject'  => 'Maintenance_Informatique'
    ]);
...
<head>
    ...
    <title>Maintenance Informatique - Ressources IAI</title>
    <meta name="description" content="Ressources de la matiere Maintenance Informatique pour Licence 2 - Semestre 4">
    <base href="<?= $base_url ?>/">
...
<body class="page-fade-in">
    ...
    <main class="container" style="padding: 4rem 0;">
        <div class="subject-header">
            <h1 style="color: var(--primary); margin-bottom: 0.5rem;">Maintenance Informatique</h1>
