...
try {
    ...
    $stmt->execute([
        ':level'    => 'L2',
        ':semester' => 'Semestre 4',
        ':subject'  => 'Techniques_de_Communication'
    ]);
...
<head>
    ...
    <title>Techniques de Communication - Ressources IAI</title>
    <meta name="description" content="Ressources de la matiere Techniques de Communication pour Licence 2 - Semestre 4">
    <base href="<?= $base_url ?>/">
...
<body class="page-fade-in">
    ...
    <main class="container" style="padding: 4rem 0;">
        <div class="subject-header">
            <h1 style="color: var(--primary); margin-bottom: 0.5rem;">Techniques de Communication</h1>
            <p style="color: var(--text-muted); margin-bottom: 1rem;">Licence 2 - Semestre 4</p>
