...
try {
    ...
    $stmt->execute([
        ':level'    => 'L1',
        ':semester' => 'Semestre 1',
        ':subject'  => 'Mathematiques_Discretes'
    ]);
...
<head>
    ...
    <title>Mathematiques Discretes - Ressources IAI</title>
    <meta name="description" content="Ressources de la matiere Mathematiques Discretes pour Licence 1 - Semestre 1">
    <base href="<?= $base_url ?>/">
...
<body class="page-fade-in">
    ...
    <main class="container" style="padding: 4rem 0;">
        <div class="subject-header">
            <h1 style="color: var(--primary); margin-bottom: 0.5rem;">Mathematiques Discretes</h1>
