...
try {
    ...
    $stmt->execute([
        ':level'    => 'L1',
        ':semester' => 'Semestre 1',
        ':subject'  => 'Architecture_et_Maintenance'
    ]);
...
<head>
    ...
    <title>Architecture et Maintenance - Ressources IAI</title>
    <meta name="description" content="Ressources de la matiere Architecture et Maintenance pour Licence 1 - Semestre 1">
    <base href="<?= $base_url ?>/">
...
<body class="page-fade-in">
    ...
    <main class="container" style="padding: 4rem 0;">
        <div class="subject-header">
            <h1 style="color: var(--primary); margin-bottom: 0.5rem;">Architecture et Maintenance</h1>
            <p style="color: var(--text-muted); margin-bottom: 1rem;">Licence 1 - Semestre 1</p>
