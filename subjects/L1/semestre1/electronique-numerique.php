...
try {
    ...
    $stmt->execute([
        ':level'    => 'L1',
        ':semester' => 'Semestre 1',
        ':subject'  => 'Electronique_Numerique'
    ]);
...
<head>
    ...
    <title>Electronique Numerique - Ressources IAI</title>
    <meta name="description" content="Ressources de la matiere Electronique Numerique pour Licence 1 - Semestre 1">
    <base href="<?= $base_url ?>/">
...
<body class="page-fade-in">
    ...
    <main class="container" style="padding: 4rem 0;">
        <div class="subject-header">
            <h1 style="color: var(--primary); margin-bottom: 0.5rem;">Electronique Numerique</h1>
