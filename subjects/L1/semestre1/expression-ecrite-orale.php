...
try {
    ...
    $stmt->execute([
        ':level'    => 'L1',
        ':semester' => 'Semestre 1',
        ':subject'  => 'Expression_Ecrite_et_Orale'
    ]);
...
<head>
    ...
    <title>Expression Ecrite et Orale - Ressources IAI</title>
    <meta name="description" content="Ressources de la matiere Expression Ecrite et Orale pour Licence 1 - Semestre 1">
    <base href="<?= $base_url ?>/">
...
<body class="page-fade-in">
    ...
    <main class="container" style="padding: 4rem 0;">
        <div class="subject-header">
            <h1 style="color: var(--primary); margin-bottom: 0.5rem;">Expression Ecrite et Orale</h1>
