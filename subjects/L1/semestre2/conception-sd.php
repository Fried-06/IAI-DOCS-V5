...
try {
    ...
    $stmt->execute([
        ':level'    => 'L1',
        ':semester' => 'Semestre 2',
        ':subject'  => 'Conception_Systemes_Distribues'
    ]);
...
<head>
    ...
    <title>Conception Systemes Distribues - Ressources IAI</title>
    <meta name="description" content="Ressources de la matiere Conception Systemes Distribues pour Licence 1 - Semestre 2">
    <base href="<?= $base_url ?>/">
...
<body class="page-fade-in">
    ...
    <main class="container" style="padding: 4rem 0;">
        <div class="subject-header">
            <h1 style="color: var(--primary); margin-bottom: 0.5rem;">Conception Systemes Distribues</h1>
            <p style="color: var(--text-muted); margin-bottom: 1rem;">Licence 1 - Semestre 2</p>
