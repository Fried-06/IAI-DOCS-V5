...
<head>
    ...
    <title>CCNA 1A - Ressources IAI</title>
    <meta name="description" content="Ressources de la matiere CCNA 1A pour Licence 1 - Semestre 2">
    <base href="<?= $base_url ?>/">
...
<body class="page-fade-in">
    ...
    <main class="container" style="padding: 4rem 0;">
        <div class="subject-header">
            <h1 style="color: var(--primary); margin-bottom: 0.5rem;">CCNA 1A</h1>
