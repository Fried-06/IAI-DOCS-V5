...
<head>
    ...
    <title>Licence 3 ASR - Ressources IAI</title>
    <base href="<?= $base_url ?>/">
...
<body class="page-fade-in">
    ...
    <main class="container" style="padding: 4rem 0;">
        <h1 style="color:var(--primary);margin-bottom:2rem;text-align:center;">Licence 3 ASR</h1>
        <div class="grid grid-cols-2">

        <a href="L3/ASR/semestre5" class="level-card">
        ...
        <a href="L3/ASR/semestre6" class="level-card">
            <div class="level-icon">
                <svg width="32" height="32" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path></svg>
            </div>
            <div>
